...
function App() {
  ...
  const fetchTasks = async () => {
    const res = await fetch('https://todolist-production-43cd.up.railway.app/tasks');
  ...
  const addTask = async () => {
    if (!text) return;
    await fetch('https://todolist-production-43cd.up.railway.app/tasks', {
      method: 'POST',
  ...
  const addSubtask = async (e, taskId) => {
    ...
    await fetch(`https://todolist-production-43cd.up.railway.app/tasks/${taskId}/subtasks`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  const toggleSub = async (e, id) => {
    ...
    await fetch(`https://todolist-production-43cd.up.railway.app/subtasks/${id}/toggle`, { method: 'PATCH' });
    fetchTasks();
  };
  ...
  const deleteTask = async (e, id) => {
    ...
    await fetch(`https://todolist-production-43cd.up.railway.app/tasks/${id}`, { method: 'DELETE' });
    fetchTasks();
  };
